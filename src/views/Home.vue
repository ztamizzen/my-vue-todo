<template>
  <div class="home">
    ...
    <div class="box text-left" v-scroll="handleScroll">
      <img alt="Vue logo" src="../assets/logo.png" class="float-left">
...
export default {
  ...
  methods: {
    // will be called once the element is visible
    handleScroll(evt, el) {
